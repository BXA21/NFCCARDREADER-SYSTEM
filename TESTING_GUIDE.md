...
- ✅ Test employee (EMP-001 / Employee@123)
- ✅ Test device with API key (note the API key!)
...
│         │                                                       │
│         ▼                                                       │
│  [ACR122U Reader detects card UID]                             │
│         │                                                       │
│         ▼                                                       │
│  [Reader Agent sends to Backend API]                            │
│         │                                                       │
│         ▼                                                       │
│  [Backend checks: First tap today?]                             │
│         │                                                       │
│    YES  │  NO                                                   │
│    ▼    ▼                                                       │
│  [Record  [Record                                               │
